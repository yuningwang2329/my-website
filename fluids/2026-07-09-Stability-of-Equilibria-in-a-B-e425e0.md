...
研究了恒化器型反应器数学模型的动力学。该模型描述了悬浮和壁附着细菌种群的时间演化，后者表示为一维生物膜，受到非繁殖生长限制底物和通过细菌利用底物形成的反应产物的影响。特别是，它表明，在平凡（冲刷）平衡不稳定的情况下，存在一个独特的局部渐近稳定的非平凡平衡。在稍强的假设下，建立了非平凡均衡的一致持久性和全局渐近稳定性。
