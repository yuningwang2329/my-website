...
这项工作研究了在存在嵌入中间各向异性电磁层的有界各向异性电磁散射体的情况下由麦克斯韦系统控制的时谐电磁散射。我们专注于周围层外界面上有限多个指定点的小边界附着邻域中总电场和磁场梯度的局部增强。我们证明，通过适当构造入射电磁波，总电场和总磁场的梯度可以在这些邻域中任意大。此外，可以根据规定的梯度大小选择局部半径，从而描述各向异性散射体附近电磁场的局部高梯度集中机制。   主要策略是基于引入辅助边界附着电磁邻域和相关电场和磁场，它们在规定点附近表现出强烈的梯度变化。利用麦克斯韦赫格洛茨波函数的近似性质，这些辅助场然后通过散射体附近物理上允许的入射波来近似。连同各向异性散射问题的适定性和连续依赖性，这意味着可以将相应的散射场控制为在相关层区域中足够弱。因此，总场由规定点附近的入射场主导，并继承其大梯度行为。
